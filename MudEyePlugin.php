...
class MudEyePlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('SEO plugin for Our Name is Mud');
    }
    ...
    {
        return array(
            'seoTitle' => array(AttributeType::String, 'label' => 'Meta Title', 'default' => ''),
            'seoDesc' => array(AttributeType::Mixed, 'label' => 'Meta Description'),
            'seoRobots' => array(AttributeType::Bool, 'label' => 'Disable page in robots.txt'),
            'trackingCode' => array(AttributeType::Mixed, 'label' => 'Google Analytics code'),
            'analyticsCode' => array(AttributeType::Mixed, 'label' => 'Google Tag Manager code'),
        );
    }
    ...
    {
       return craft()->templates->render('mudeye/MudEye_Settings', array(
